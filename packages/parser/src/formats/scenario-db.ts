...
export function decodeScenarioDb(bytes: Uint8Array, opts: DecodeScenarioDbOpts): ScenarioDb {
  ...
  for (let i = 0; i < MONSTER_RECORD_COUNT; i++) {
    ...
    monsters.push({
      ...
      attack1HpDrainChance: statSlice[8]!,
      attack1AgeChance: statSlice[11]!,
      attack1DecapitateChance: statSlice[14]!,
      attack2HpDrainChance: statSlice[24]!,
      attack2AgeChance: statSlice[27]!,
      attack2DecapitateChance: statSlice[30]!,
      attack3HpDrainChance: statSlice[40]!,
      attack3AgeChance: statSlice[43]!,
      attack3DecapitateChance: statSlice[46]!,
      attack1Style: statSlice[17]!,
      attack1DamageBonus: statSlice[20]!,
      attack2Style: statSlice[33]!,
      ...
      spellPowerChance: statSlice[104]!,
      auxSave106: statSlice[106]!,
      flyEvadeChance: statSlice[111]!,
    });
  }
